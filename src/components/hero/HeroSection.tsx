    ...
    >
      ...
      <div className="w-full flex flex-col items-center gap-[120px]">
        ...
        <div className="flex flex-col items-center gap-[30px] w-full text-center">
          <motion.h1
            className="text-[64px] leading-[52px] tracking-[-0.03em] font-bold text-brand w-full max-md:text-[40px] max-md:leading-[44px] max-sm:text-[32px] max-sm:leading-[36px]"
            custom={0.1}
            initial="hidden"
            animate="visible"
            variants={fadeUp}
