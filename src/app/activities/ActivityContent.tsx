    ...
    <main className="pt-[109px] pb-[120px] flex flex-col gap-10">
      {secondary && (
        <div className="w-full max-w-[1200px] mx-auto px-[var(--side-padding)]">
          <div className="feathered-image w-full aspect-[16/9] rounded-xl overflow-hidden bg-gray-70">
      ...
      <article className="w-[706px] max-w-[calc(100%-80px)] mx-auto flex flex-col gap-4">
        ...
        {gallery.length > 0 && (
          <div className="mt-6 grid grid-cols-2 gap-4 max-md:grid-cols-1">
            {gallery.map((src) => (
              <div key={src} className="feathered-image-sm w-full aspect-[4/3] rounded-[20px] overflow-hidden bg-gray-70">
                {/* eslint-disable-next-line @next/next/no-img-element */}
