...
export default function GlobePage() {
  ...
  function initGlobe() {
    ...
    if (!container || typeof Globe !== 'function' || globeInstanceRef.current) return;

    const TYPES = ['surveilling', 'providing', 'funding'] as const;
    const ARC_COUNT = 60;
    const arcs = [];
  ...
  return (
    <>
      ...
      <Script
        ...
        onLoad={initGlobe}
      />
      <div id="globe-standalone" ref={containerRef}></div>
    </>
  );
}
